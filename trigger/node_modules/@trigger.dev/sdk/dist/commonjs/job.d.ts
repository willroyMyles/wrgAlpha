import { FailedRunNotification, IntegrationConfig, InvokeOptions, JobMetadata, Prettify, RunNotification, SuccessfulRunNotification } from "@trigger.dev/core";
...
import type { EventSpecification, Trigger, TriggerContext, TriggerEventType, TriggerInvokeType } from "./types.js";
export type JobOptions<TTrigger extends Trigger<EventSpecification<any>>, TIntegrations extends Record<string, TriggerIntegration> = {}, TOutput extends any = any> = {
...
export type JobPayload<TJob> = TJob extends Job<Trigger<EventSpecification<infer TEvent>>, any> ? TEvent : never;
export type JobIO<TJob> = TJob extends Job<any, infer TIntegrations> ? IOWithIntegrations<TIntegrations> : never;
...
export declare class Job<TTrigger extends Trigger<EventSpecification<any>>, TIntegrations extends Record<string, TriggerIntegration> = {}, TOutput extends any = any> {
    #private;
