...
exports.ExternalSourceTrigger = exports.ExternalSource = void 0;
exports.omit = omit;
...
class ExternalSourceTrigger {
    ...
    toJSON() {
        return {
            ...
            rule: {
                ...
                payload: (0, core_1.deepMergeFilters)(this.options.source.filter(this.options.params, this.options.options), this.event.filter ?? {}, this.options.params.filter ?? {}),
    ...
    attachToJob(triggerClient, job) {
        triggerClient.attachSource({
            key: (0, utils_js_1.slugifyId)(this.options.source.key(this.options.params)),
