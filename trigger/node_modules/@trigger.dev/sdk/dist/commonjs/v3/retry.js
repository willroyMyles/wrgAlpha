    ...
    return tracer_js_1.tracer.startActiveSpan(`retry.onThrow()`, async (span) => {
        ...
        while (attempt <= opts.maxAttempts) {
            ...
            try {
                ...
                innerSpan.end();
                await v3_1.runtime.waitForDuration(nextRetryDelay);
            }
            finally {
                attempt++;
            }
        ...
        while (true) {
            try {
                ...
                if (nextRetry.type === "delay") {
                    span.setAttribute(v3_1.SemanticInternalAttributes.RETRY_AT, new Date(Date.now() + nextRetry.value).toISOString());
                    ...
                    span.end();
                    await v3_1.runtime.waitForDuration(nextRetry.value);
                }
                else {
                    const now = Date.now();
                    ...
                    span.end();
                    await v3_1.runtime.waitUntil(new Date(nextRetry.value));
                }
            }
            catch (e) {
