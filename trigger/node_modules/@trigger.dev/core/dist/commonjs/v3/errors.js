...
exports.GracefulExitTimeoutError = exports.SigKillTimeoutProcessError = exports.CancelledProcessError = exports.CleanupProcessError = exports.UnexpectedExitError = exports.TaskIndexingImportError = exports.TaskMetadataParseError = exports.UncaughtExceptionError = exports.AbortTaskRunError = void 0;
...
function getFriendlyErrorMessage(code, signal, stderr, dockerMode = true) {
    ...
    if (code === 137) {
        if (dockerMode) {
            return message("Process ran out of memory! Try choosing a machine preset with more memory for this task.");
        }
        else {
            // Note: containerState reason and message should be checked to clarify the error
            return message("Process most likely ran out of memory, but we can't be certain. Try choosing a machine preset with more memory for this task.");
        }
    }
