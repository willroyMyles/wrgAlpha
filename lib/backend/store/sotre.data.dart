...
var USCategories = processList();
var USCars = processCars();
var USTags = tags();

List<String> getCategories() {
  var list = USCategories.map((e) => e.first).toList();
...
Interior Accessories,Carpet & Vinyl  Floor Kits,Dash & Dash Accessories,Floor Mats & Liners, Seat Covers & Accessories,Switches,  Relays , Wiring & Components
...
updateDb() async {
  ...
  //     var key = l[0];
  //     try {
  //       await Supabase.instance.client.rest.from("Model").insert({
  //         "makeId": key,
  //         "id": item.replaceAll(key, ""),
  //       });
  //     } catch (e) {
  //       print("could not inset $key");
  //     }
  //     inserted++;
  //     print(inserted);
  //   }
...
updateDbSub() async {
  ...
  //     var key = l[0];
  //     try {
  //       await Supabase.instance.client.rest.from("SubCategory").insert({
  //         "categoryId": key,
  //         "id": item,
  //       });
  //     } catch (e) {
...
updateDbCategory() async {
  ...
  //     var key = l[0];
  //     try {
  //       await Supabase.instance.client.rest.from("Category").insert({
  //         "id": key,
  //       });
  //     } catch (e) {
  //       print("could not inset $key");
